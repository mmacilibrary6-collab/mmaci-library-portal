...
<div class="container-fluid py-4">
    ...
    <div class="row g-3 mb-4 dashboard-secondary-stats">
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <a
                        href="{{ route('admin.ask-librarian.index') }}"
                        class="stat-link">
        ...
        <div class="col-xl-3 col-md-6">
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <a
                        href="{{ route('admin.visiting-users.index') }}"
                        class="stat-link">
                    ...
                    @forelse($latestMessages ?? [] as $message)
                        ...
                        <div class="activity-item">
                            ...
                            <div class="activity-details">
                                ...
                                <p class="activity-meta text-truncate mb-0">

                                    {{ $message->question ?? 'No question provided.' }}
                ...
                <div class="panel-body">
                        ...
                        <div class="activity-item">
                            ...
                            <div class="activity-details">
                                ...
                                <p class="activity-meta mb-0">
                                    ...
                                    {{ $visitor->school ?? 'School not specified' }}
                    ...
                    @empty
                        ...
                        <div class="empty-state">
                            ...
                            <p>
                                Visiting-user submissions will appear here.
                            </p>
