...
@section('title', 'Thesis & Dissertation Programs')
@section('page-title', 'Thesis & Dissertation Programs')

@section('content')
<div class="container-fluid thesis-programs-page">
    ...
    <section class="programs-hero">
        <div class="hero-copy">
            ...
            <div>
                <span class="hero-eyebrow">Thesis & Dissertation Management</span>
                <h2>Academic Programs</h2>
                <p>Organize the programs displayed in your Thesis & Dissertation Collection.</p>
            </div>
        </div>

        <a href="{{ route('admin.thesis-programs.create') }}" class="btn-add-program">
    ...
    <section class="programs-panel">
        <div class="panel-toolbar">
            ...
            <form method="GET" action="{{ route('admin.thesis-programs.index') }}" class="program-search">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions">
                                    <a href="{{ route('admin.thesis-programs.edit', $program) }}"
                                    ...
                                    <form
                                        action="{{ route('admin.thesis-programs.destroy', $program) }}"
                                        method="POST"
