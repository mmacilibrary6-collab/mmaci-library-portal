...
@section('title', 'Thesis & Dissertation Folders')
@section('page-title', 'Thesis & Dissertation Folders')
...
<div class="container-fluid folder-page">
    ...
    <div class="folder-page-header">
        ...
        <div class="folder-heading">
            ...
            <div>
                ...
                <h2>Thesis & Dissertation Folders</h2>
    ...
    <div class="folder-management-card">
        ...
        <form
            method="GET"
            action="{{ route('admin.thesis-folders.index') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="folder-actions">
                                    ...
                                    <a
                                        href="{{ route('admin.thesis-folders.edit', $folder) }}"
                                    ...
                                    <form
                                        action="{{ route('admin.thesis-folders.destroy', $folder) }}"
                                        method="POST"
                                        onsubmit="return confirm('Delete this thesis/dissertation folder?');">
                        ...
                        <tr>
                            ...
                            <td colspan="6">
                                ...
                                <div class="folder-empty-state">
                                    ...
                                    <h4>No thesis/dissertation folders found</h4>
