@php
    $folder = isset($thesisFolder) ? $thesisFolder : null;
    $isEditing = $folder !== null;

    $programId = old(
        'thesis_program_id',
        $folder?->thesis_program_id ?? ($selectedProgramId ?? '')
    );
...
<div class="folder-form">
    <div class="form-section">
        <div class="section-heading">
            ...
            <div>
                ...
                <p>Enter the basic details for this Thesis & Dissertation folder.</p>
            </div>
        </div>

        <div class="row g-4">
            <div class="col-lg-6">
                <label for="thesis_program_id" class="form-label">
                    Academic Program <span>*</span>
                </label>

                <select
                    name="thesis_program_id"
                    id="thesis_program_id"
                    class="form-select @error('thesis_program_id') is-invalid @enderror"
                    required>
    ...
    <div class="form-actions">
        <a href="{{ route('admin.thesis-folders.index') }}" class="btn-cancel">
