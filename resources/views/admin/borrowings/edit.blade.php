...
<div class="container-fluid borrowing-edit-page">
    ...
    <form action="{{ route('admin.borrowings.update', $borrowing) }}" method="POST" class="edit-panel">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="semester"
                        value="{{ old('semester', $borrowing->borrower?->semester) }}">
        ...
        <section class="form-section">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                        @foreach(['pending', 'approved', 'borrowed', 'returned', 'overdue', 'rejected'] as $status)
                            <option
                                value="{{ $status }}"
                                @selected(old('status', $borrowing->status) === $status)>
                                {{ ucfirst($status) }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input
                        class="form-control @error('returned_by') is-invalid @enderror"
                        name="returned_by"
        ...
        <div class="form-actions">
            <a href="{{ route('admin.borrowings.show', $borrowing) }}" class="cancel-btn">
                Cancel
            </a>
...
.form-select:focus{
    border-color:#8aa8c6;
    box-shadow:0 0 0 3px rgba(24,75,140,.08)!important;
}
...
@media (max-width:991.98px){
    .edit-hero{align-items:flex-start;flex-direction:column}
}
