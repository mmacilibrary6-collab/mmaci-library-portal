        ...
        <div class="hero-left">
            ...
            <div>
                ...
                <div class="hero-title-row">
                    <h1>{{ $borrower->name }}</h1>
                    <span class="type-badge type-{{ $borrowerType ?: 'unset' }}">
                        {{ $borrowerTypeLabel }}
                    </span>
                </div>
    ...
    <section class="borrower-info-panel">
        ...
        <div class="info-grid">
            ...
            <div class="info-card">
                ...
                <strong>
                    <span class="profile-type type-{{ $borrowerType ?: 'unset' }}">{{ $borrowerTypeLabel }}</span>
                </strong>
            </div>
...
.hero-icon{
    ...
    color:#0b315e;background:var(--yellow);border-radius:22px;font-size:29px;
}
.hero-eyebrow{
...
.profile-hero h1{margin:0;font-size:36px;font-weight:800;letter-spacing:-.03em}
.profile-hero p{margin:6px 0 0;color:rgba(255,255,255,.84);font-size:14px}
.type-badge{
...
.hero-btn{
    ...
    gap:8px;border-radius:14px;font-size:12px;font-weight:800;text-decoration:none;white-space:nowrap;
}
.hero-btn-light{color:#0b315e;background:#fff;border:1px solid rgba(255,255,255,.7)}
.hero-btn-yellow{color:#0b315e;background:var(--yellow);border:1px solid #e6aa00}
.borrower-info-panel,.history-panel{
    background:#fff;border:1px solid var(--line);border-radius:24px;
    box-shadow:0 10px 25px rgba(16,48,82,.05);
}
.borrower-info-panel{margin-bottom:22px;padding-bottom:22px}
.panel-heading{padding:22px 24px 18px}
.panel-heading h2{margin:0;color:#0b315e;font-size:20px;font-weight:800}
.panel-heading p{margin:4px 0 0;color:var(--muted);font-size:12px}
.info-grid{
    padding:0 24px;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;
}
.info-card{
    min-height:93px;padding:16px 18px;background:#f7f9fc;border:1px solid #dee7f0;border-radius:15px;
}
.info-wide{grid-column:span 2}
.info-card>span{
    display:block;margin-bottom:7px;color:#75879d;font-size:10px;font-weight:800;
    letter-spacing:.05em;text-transform:uppercase;
}
.info-card strong{
    display:block;color:#0b315e;font-size:13px;font-weight:800;overflow-wrap:anywhere;
}
.profile-type{
    display:inline-flex!important;padding:6px 10px;border-radius:999px;
    font-size:10px!important;text-transform:uppercase;
}
.history-panel{overflow:hidden}
.history-heading{border-bottom:1px solid var(--line)}
.borrower-history-table{min-width:1050px}
.borrower-history-table th{
    padding:14px 16px;color:#7b8ca2;background:#f6f9fc;border-bottom:1px solid var(--line);
    font-size:10px;font-weight:800;letter-spacing:.05em;text-transform:uppercase;white-space:nowrap;
}
.borrower-history-table td{padding:15px 16px;color:#5b6d81;border-color:#edf1f5;font-size:12px}
.row-number{width:44px;color:#95a2b0!important}
.material-cell{min-width:280px;max-width:390px}
.material-cell strong{color:#0b315e;font-weight:800}
.accession-chip{
    display:inline-flex;align-items:center;min-height:35px;padding:0 12px;color:#0b315e;
    background:#f0f6fc;border:1px solid #d8e5f0;border-radius:10px;
    font-family:ui-monospace,SFMono-Regular,Consolas,monospace;font-size:11px;font-weight:800;
}
.status-badge{
...
.empty-icon{
    ...
    color:#245f94;background:#eef5fb;border-radius:18px;font-size:24px;
}
