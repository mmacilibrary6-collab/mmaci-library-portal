...
<div class="container-fluid resource-edit-page">
    ...
    <div class="resource-page-container">
        ...
        <section class="resource-page-header">
            ...
            <div class="resource-header-content">
                ...
                <div>
                    <span class="resource-header-eyebrow">
                        Digital Resources
                    </span>
                    ...
                    <p>
                        ...
                        <strong>{{ $openAccessResource->title }}</strong>.
                    </p>
                </div>
        ...
        @if ($errors->any())
            ...
            <div class="resource-form-alert" role="alert">

                <span class="resource-alert-icon">
                    <i class="bi bi-exclamation-triangle-fill"></i>
                </span>

                <div class="resource-alert-content">
        ...
        <form
            ...
            @include('admin.open-access-resources._form')
...
<style>
    ...
    .resource-alert-content strong {
        display: block;
        margin-bottom: 2px;
        font-size: 13px;
    }

    .resource-alert-content p {
        margin: 0;
        color: #a35b5b;
        font-size: 11px;
    }

    .resource-alert-content ul {
        margin: 9px 0 0;
        padding-left: 18px;
        color: #9a4b4b;
        font-size: 11px;
