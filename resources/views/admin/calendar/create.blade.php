...
<div class="container-fluid admin-page py-4">
    <section class="admin-page-header">
        <div class="admin-page-heading">
            <span class="admin-page-icon"><i class="bi bi-calendar-plus"></i></span>
            <div>
                <span class="admin-page-eyebrow">Website Content</span>
                <h2>Create Calendar Event</h2>
                <p>Add a new activity or announcement to the library calendar.</p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.calendar.store') }}">
            ...
            <div class="row g-4">
                <div class="col-12">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title') }}" class="form-control @error('title') is-invalid @enderror" placeholder="Enter the event title" maxlength="255" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="time" id="start_time" name="start_time" value="{{ old('start_time') }}" class="form-control @error('start_time') is-invalid @enderror">
                    @error('start_time') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="col-md-4">
                    <label for="end_time" class="form-label">End Time</label>
                    <input type="time" id="end_time" name="end_time" value="{{ old('end_time') }}" class="form-control @error('end_time') is-invalid @enderror">
                    @error('end_time') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="col-md-8">
                    <label for="location" class="form-label">Location</label>
                    <input type="text" id="location" name="location" value="{{ old('location') }}" class="form-control @error('location') is-invalid @enderror" placeholder="Example: MMACI Library Services Office" maxlength="255">
                ...
                <div class="col-12">
                    ...
                    <textarea id="description" name="description" rows="6" class="form-control @error('description') is-invalid @enderror" placeholder="Write a short description of the event">{{ old('description') }}</textarea>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-warning rounded-pill px-4 fw-semibold"><i class="bi bi-calendar-plus me-2"></i>Create Event</button>
            </div>
        </form>
    </section>
</div>
