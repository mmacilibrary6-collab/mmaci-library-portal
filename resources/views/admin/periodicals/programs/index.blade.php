            ...
            <table class="table programs-table align-middle mb-0">
                ...
                @forelse($programs as $program)
                    <tr>
                        ...
                        <td><div class="program-identity"><div class="program-thumbnail"><img src="{{ $program->image_url }}" alt="{{ $program->title }}" onerror="this.onerror=null;this.src='{{ asset('images/image-fallback.svg') }}';"></div><div><strong>{{ $program->title }}</strong><small>Periodical program</small></div></div></td>
