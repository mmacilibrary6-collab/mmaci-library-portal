...
class XlsxExport
{
    public function create(array $headers, iterable $rows, string $sheetName = 'Folders'): string
    {
        ...
        try {
            ...
            $zip->addFromString('xl/workbook.xml', '<?xml version="1.0"?><workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"><sheets><sheet name="'.htmlspecialchars($sheetName, ENT_XML1, 'UTF-8').'" sheetId="1" r:id="rId1"/></sheets></workbook>');
